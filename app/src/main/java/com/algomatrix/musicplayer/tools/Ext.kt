package com.algomatrix.musicplayer.tools
...
object Ext{
    inline fun Bitmap.dominantColor(crossinline color:(androidx.compose.ui.graphics.Color) -> Unit) : Int {
    ...
    inline fun Bitmap.vibrabtColor(crossinline  color : (Color) -> Unit) : Int {
        Palette.Builder(this).generate{
            it?.let{
                palette ->
